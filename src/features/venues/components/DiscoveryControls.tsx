          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-1.5 px-1 animate-in fade-in slide-in-from-left-2 duration-700">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-slate-500">
                Near:{" "}
                <span className="text-white">{mapRegion.toUpperCase()}</span>
              </span>
              <button
                onClick={() => {
                  handleInteraction();
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-1">
          ...
          <div className="relative">
            ...
            >
              ...
              <ChevronRight
                className={`w-3 h-3 transition-transform ${showVibeMenu ? "rotate-90" : ""}`}
              />
            </button>
          </div>
          ...
          <div className="relative">
            ...
            >
              ...
              <ChevronRight
                className={`w-3 h-3 transition-transform ${showEventMenu ? "rotate-90" : ""}`}
              />
            </button>
          </div>
          ...
          <div className="relative">
            ...
            >
              <Dices className="w-3 h-3" /> Play{" "}
              <ChevronRight
                className={`w-3 h-3 transition-transform ${showPlayMenu ? "rotate-90" : ""}`}
              />
            </button>
          </div>
          ...
          <div className="relative">
            ...
            >
              <Theater className="w-3 h-3" /> Scene{" "}
              <ChevronRight
                className={`w-3 h-3 transition-transform ${showSceneMenu ? "rotate-90" : ""}`}
              />
            </button>
          </div>
          ...
          <div className="relative">
            ...
            >
              ...
              <ChevronRight
                className={`w-3 h-3 transition-transform ${showFeatureMenu ? "rotate-90" : ""}`}
              />
            </button>
          </div>
