...
export const VibeCheckSchema = z.object({
  venueId: z.string().min(1),
  status: z.enum(["trickle", "flowing", "gushing", "flooded"]),
...
export const UserUpdateSchema = z.object({
  handle: z
    ...
    .regex(
      /^[a-zA-Z0-9_]{3,15}$/,
      "Handle must be 3-15 characters and alphanumeric (no special characters except underscores)",
    )
    .optional(),
  ...
  phone: z
    ...
    .regex(
      /^\d{3}-\d{3}-\d{4}$/,
      "Invalid phone format. Please use 555-555-5555",
    )
    .optional()
    .or(z.literal("")),
...
export const VenueUpdateSchema = z.object({
  ...
  geoLoop: z
    .enum(["Downtown_Walkable", "Warehouse_Tumwater", "Destination_Quest"])
    .optional()
    .or(z.literal("")),
  ...
  venueType: z
    ...
    .optional(),
  establishmentType: z
    .enum(["Bar Only", "Bar & Restaurant", "Restaurant with Bar", "Brewpub"])
    .optional(),
  ...
  makerType: z
    .enum(["Brewery", "Distillery", "Cidery", "Winery", "Other"])
    .optional()
    .or(z.literal("")),
  ...
  photos: z
    .array(
      z.object({
        ...
        marketingStatus: z
          .enum(["pending-super", "pending-venue", "approved", "rejected"])
          .optional(),
...
export const VenueSchema = z.object({
  ...
  sceneTags: z.array(z.string()).optional(),
  foodService: z
    .enum(["full_kitchen", "limited_kitchen", "snacks", "none_byof"])
    .optional(),
  status: z.enum(["trickle", "flowing", "gushing", "flooded"]).optional(),
  clockIns: z.number().optional(),
  capacity: z.number().optional(),
  isPaidLeagueMember: z.boolean().optional(),
